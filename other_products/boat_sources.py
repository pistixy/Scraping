...
# Specific page URL
url = base_url + '/evaporation-sources.cfm?section=boat-sources'
...
if response.status_code == 200:
    ...
    links = []
    bad_links = ["/newweb/deposition_materials/materialdepositionchart.cfm?pgid=0",
                 "/newweb/deposition_materials/evaporation-process-notes.cfm",
                 "/materials-calculators.cfm",
                 "/newweb/evaporation_sources/evaporation_tempvspower.cfm?pgid=0",
    ...
    with open('other_products/boat_sources.txt', 'w', encoding='utf-8') as file:
        file.write('Description,No. per Parck,Volts,Amps,Watts,Temp., Direction , weight,Price\n')  # Corrected header names and added newline
